        ...
        <>
            <div className="card lg:card-side ">
                <div className="card-body">
                    <h1 className="card-title text-5xl font-serif mt-10 ">Contact Us  </h1>
                    <h2 className="card-title text-3xl font-normal font-serif mt-3 ">We're Always Happy To Help You</h2>

                    <div className="grow-0 shrink-0 basis-auto mt-10">
                        <div className="flex flex-wrap">
                            <div className="mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 px-3 ">
                                <div className="flex items-start">
                                    <div className="shrink-0">
                                        <div className="p-4 bg-accent-focus rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                                    ...
                                    <div className="grow ml-6">
                                        <p className="font-bold mb-1 font-serif">Technical support</p>
                            ...
                            <div className="mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 px-3 ">
                                <div className="flex items-start">
                                    ...
                                    <div className="grow ml-6">
                                        <p className="font-bold mb-1 font-serif">Sales questions</p>
                            ...
                            <div className="mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 px-3 ">
                                <div className="flex align-start">
                                    ...
                                    <div className="grow ml-6">
                                        <p className="font-bold mb-1 font-serif">Press</p>
                            ...
                            <div className="mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 px-3 ">
                                <div className="flex align-start">
                                    ...
                                    <div className="grow ml-6">
                                        <p className="font-bold mb-1 font-serif">Bug report</p>
                ...
                <figure className="w-3/5 mb-14"><img src="/images/contactupcut.png" alt="Album" /></figure>
                <div className="mb-5">
                    </div>
            </div>
